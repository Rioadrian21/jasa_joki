...
<div class="container-fluid mt-4">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form action="<?= base_url('menu/changepassword'); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control text-dark" id="new_password1" name="new_password1">
                    <?= form_error('new_password1', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>
                <div class="form-group">
                    <label for="new_password2">Repeat Password</label>
                    <input type="password" class="form-control text-dark" id="new_password2" name="new_password2">
